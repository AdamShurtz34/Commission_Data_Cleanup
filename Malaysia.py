...
def ExecuteMalaysia(fileName):
  wb = Workbook()
  ws = wb.active
  ws.title = "Malaysia Commission Payout"
  sumCom = 0
  ...
  rowIndex=2
  bankNamesandSwift = {"AMBANK":["ARBKMYKL"], "AMBank":["ARBKMYKL"], "AMBANK BERHAD":["ARBKMYKL"], "AMBANK Berhad":["ARBKMYKL"], "Ambank":["ARBKMYKL"],
                       "Affin Bank Berhad":["PHBMMYKL"], "CIMB":["CIBBMYKL"], "CIMB Bank":["CIBBMYKL"], "CIMB Bank Berhad":["CIBBMYKL"],
                       "CIMB BANK BHD":["CIBBMYKL"], "Citibank":["CITIMYKL"], "Hong Leong Bank":["HLBBMYKL"],
                       "HONG LEONG BANK":["HLBBMYKL"], "Hong Leong Bank Berhad":["HLBBMYKL"], "HSBC":["HBMBMYKL"],
                       "Malayan Banking Berhad":["MBBEMYKL"], "Malayan Banking":["MBBEMYKL"], "Maybank":["MBBEMYKL"], "MAYBANK":["MBBEMYKL"],
                       "OCBC":["OCBCMYKL"], "Public Bank":["PBBEMYKL"], "Public Bank Berhad":["PBBEMYKL"], "RHB Bank":["RHBBMYKL"],
                       "UOB Bank":["UOVBMYKL"], "Alliance Bank Berhad":["MFBBMYKL"], "Alliance Bank":["MFBBMYKL"], "Standard Chartered":["SCBLMYKX"],
                       "Public Islamic Bank Bhd":["PIBEMYK1"]}
  today = date.today()
  rd = REL.relativedelta(days=1, weekday=REL.FR)
  next_friday = today + rd
  today = next_friday.strftime("%#m-%#d-%Y")
  file = open("Malaysia_change_log_" + today + ".txt", "a")
      ...
      if rowIndex == 1:
        ...
        if colIndex==11:
          if cell.value != "MY":
            oldBC = cell.value
            cell.value = "MY"
            file.write("ID: " + str(username.value) + ", bank Country changed to MY" + " from ''" + oldBC + "''"  +"\n")
        ...
        if colIndex==13:
          if cell.value != "myr":
            oldC = cell.value
            cell.value = "myr"
            file.write("ID: " + str(username.value) + ", currency changed to myr" + " from ''" + oldC + "''"  +"\n")
  ...
  wb.save("Malaysia Commission Payout File " + today + ".xlsx")
  file.close
